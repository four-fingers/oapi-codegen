...
//go:generate go run github.com/four-fingers/oapi-codegen/cmd/oapi-codegen --config=models.cfg.yaml ../../petstore-expanded.yaml
...
import (
	...
	"github.com/four-fingers/oapi-codegen/examples/petstore-expanded/echo/api/models"
)
